...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppStarshipApiTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _httpUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./httpUtils */
          ...
          return this.http.get('https://swapi.co/api/starships/', {
            ...
            return Promise.all(shipList.results.map(function (ship) {
              ...
              return _this.http.get(ship.films[0], {
                headers: _httpUtils__WEBPACK_IMPORTED_MODULE_1__["jsonRequestHeaders"]
              }).toPromise(Promise).then(function (film) {
                // console.log(film);
    ...
    StarshipApi.ɵfac = function StarshipApi_Factory(t) {
      return new (t || StarshipApi)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
    };
  ...
  function srcAppStarshipListTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function StarshipListComponent_li_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var StarshipListComponent = function StarshipListComponent(api) {
      ...
      this.starships = [];
      api.loadStarships().then(function (data) {
        return _this2.starships = data;
      }).catch(function (_err) {
        return _this2.starships = [];
      });
    };
